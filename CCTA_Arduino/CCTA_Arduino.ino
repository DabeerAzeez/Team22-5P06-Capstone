...
float interpolatePressure(float adc_value, int sensor) {
  ...
  static const float voltage_V1[17] = { 62, 155, 232, 340, 433, 530, 640, 719, 810, 887, 945, 965, 970, 974, 979, 985, 990};
  ...
  static const float voltage_V2[19] = { 20, 110, 177, 252, 321, 427, 541, 638, 734, 845, 944, 955, 958, 961, 966, 971, 976, 979, 983 };
  ...
  static const float voltage_V3[18] = { 9, 61, 131, 227, 317, 434, 563, 683, 786, 895, 963, 965, 969, 974, 979, 983, 987, 991};
